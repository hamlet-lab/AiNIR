...
> **Status:** the public-launch candidate gate has been completed. `hamlet-lab/AiNIR` is now public and the Python distribution is `ainir`. This document is retained to preserve the reasoning and public/private boundary that preceded launch; it is not a current "before publishing" checklist.
...
- preserve `docs/public_private_boundary.md`;
